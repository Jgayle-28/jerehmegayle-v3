...
export default function Contact() {
  ...
  return (
    <section>
      <div className='max-w-6xl mx-auto h-36 md:h-48 bg-white dark:bg-brandBlack antialiased'>
        <motion.h1
      ...
      <motion.div
        ...
        initial='hidden'
        animate='visible'
        className='relative z-10 rounded-md shadow-md p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 bg-brandGray dark:bg-brandBlack  z-0'
      >
